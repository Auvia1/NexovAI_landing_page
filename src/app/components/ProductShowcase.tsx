      ...
      <div className="mx-auto max-w-7xl space-y-24">
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          >
            ...
            <h2 className="mb-4 text-4xl font-bold text-slate-900 md:text-5xl">NexovAI Admin Portal</h2>
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          >
            ...
            <h2 className="mb-4 text-4xl font-bold text-slate-900 md:text-5xl">NexovAI Clinic Portal</h2>
            <p className="mb-6 text-lg leading-relaxed text-slate-600">
