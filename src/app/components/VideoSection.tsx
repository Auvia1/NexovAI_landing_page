        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          >
            <h2 className="mb-6 text-3xl font-bold leading-tight text-white md:text-4xl lg:text-5xl">
              At NexovAI, we believe in a holistic approach that improves the quality of life for both individuals
              ...
              <div className="relative aspect-video bg-slate-900">
                ...
                <div className="flex size-full items-center justify-center bg-gradient-to-br from-slate-800 to-slate-900">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-white/70">NexovAI - Healthcare ecosystem at your fingertips</p>
                  </div>
                </div>
